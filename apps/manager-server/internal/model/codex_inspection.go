...
type CodexWeeklyPoolEstimate struct {
	...
	ClosedBoundaryCount   int      `json:"closedBoundaryCount,omitempty"`
	RequiredBoundaryCount int      `json:"requiredBoundaryCount,omitempty"`
	NextBoundaryAtMS      int64    `json:"nextBoundaryAtMs,omitempty"`
