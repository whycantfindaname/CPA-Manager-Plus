...
export interface CodexWeeklyPoolEstimate {
  ...
  role?: 'current_estimate' | 'formal_baseline' | string;
  intervalKind?: 'partial_cycle' | 'cycle_complete' | 'cycle_approximate' | string;
  ...
  quotaKind?: string;
  captureState?: 'pending' | 'closed' | string;
  routeScope?: 'observed' | string;
  quotaScope?: 'matched' | 'mixed' | string;
